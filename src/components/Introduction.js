  ...
  return (
    ...
    >
        ...
        <Grid container item xs={12} justify="center" id="my-image-container">
          ...
          >
            <Typography variant="body2" gutterBottom>I am an alumnus of MSIT, Janakpuri which is affliated to Guru
              Gobind Singh Indraprastha University (GGSIPU) who graduated with a B.Tech in Electronics and Communications (ECE).
            </Typography>
            ...
            <Typography variant="body2" gutterBottom>
              ...
              dream that I could one day make something similar that fills
              others with similar awe and joy as I was when I played them.
            </Typography>
